window.generators.methodsGenerator = (() => {
    ...
    function generateStudyDesignHTML(stats, commonData) {
        ...
        return `
            ...
            <p>${regulatoryStatement} This analysis involved a fully blinded re-evaluation of a retrospective cohort of ${helpers.formatValueForPublication(nOverall, 0)} consecutive patients with histopathologically confirmed rectal cancer who underwent pelvic MRI for primary staging or restaging between November 2015 and March 2025. This cohort represents an expansion of a previously reported patient sample ${helpers.getReference('Lurz_Schaefer_2025')}.</p>
